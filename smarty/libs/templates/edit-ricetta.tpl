    ...
    <div class="col-md-8 col-lg-9">
        <div class="recipe-set submit-recipe-set">
            ...
            <div class="submit-recipe-form">
                <form action="/chefskiss/Ricette/confermaModifiche/{$ricetta->getid()}/{$immagine->getid()}" method="post" enctype="multipart/form-data">
                        ...
                        {for $i = 0; $i < count($ingredienti); $i++}
                            <li>
                                <div class="add-fields">
                                    ...
                                    <input type="text" placeholder="farina: 200g" value="{$ingredienti[$i]}" name="ingredients[]" id="ingredients"/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <br>
                            <input type="number" min="1" placeholder="1" name="servings" id="servings" value="{$ricetta->getDosiPersone()}" required/>
                        </div>
                    </div>
