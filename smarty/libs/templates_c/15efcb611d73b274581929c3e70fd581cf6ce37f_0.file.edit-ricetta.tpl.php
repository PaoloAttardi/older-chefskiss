...
" width=80 height=80 alt="ricetta" class="rounded">
                    ...
                    <fieldset class="ingredient-set">
                        <label for="ingredients">Modifica gli ingredienti usati</label>
                        <ul class="list-sortable ingredients-list">
                        <?php
$_smarty_tpl->tpl_vars['i'] = new Smarty_Variable(null, $_smarty_tpl->isRenderingCache);
$_smarty_tpl->tpl_vars['i']->value = 0;
if ($_smarty_tpl->tpl_vars['i']->value < count($_smarty_tpl->tpl_vars['ingredienti']->value)) {
for ($_foo=true;$_smarty_tpl->tpl_vars['i']->value < count($_smarty_tpl->tpl_vars['ingredienti']->value); $_smarty_tpl->tpl_vars['i']->value++) {
?>
                            <li>
                                <div class="add-fields">
                                    <span class="handler-list"><i class="fa fa-arrows"></i></span>
                                    <input type="text" placeholder="farina: 200g" value="<?php echo $_smarty_tpl->tpl_vars['ingredienti']->value[$_smarty_tpl->tpl_vars['i']->value];?>
...
"><?php echo $_smarty_tpl->tpl_vars['categorie']->value->getCategoria();?>
                        ...
                        <div class="col-sm-6">
                            ...
                            <br>
                            <input type="number" min="1" placeholder="1" name="servings" id="servings" value="<?php echo $_smarty_tpl->tpl_vars['ricetta']->value->getDosiPersone();?>
" required/>
                        </div>
                    </div>
                    <div class="text-center">
                        <button type="submit" class="recipe-submit-btn">Conferma le modifiche alla tua ricetta</button>
                    </div>
                </form>
            </div>
        </div>
